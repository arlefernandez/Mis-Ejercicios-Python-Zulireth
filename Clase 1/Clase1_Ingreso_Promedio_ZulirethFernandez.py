...
#Si quiero que me muestre el promedio con formato de moneda, como hago? En python no hay formato moneda..
#Si quiero que me muestre el promedio con separador de miles, como hago?

numero_float = 1234567.8912
# Con miles (coma) y dos decimales (f)
print(f"{numero_float:,.2f}") # Salida: 1,234,567.89

# Con miles (coma) y sin decimales (f)
print(f"{numero_float:,.0f}") # Salida: 1,234,568 (redondeado)

# Con separador de miles (punto) y dos decimales, según configuración regional
# (requiere el módulo locale, pero la f-string con ',' es más común)
# print(f"{numero_float:.2f}") # Salida: 1234567.89 (sin separador de miles)